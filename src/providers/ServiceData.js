const ServiceData = {
    ...
    "network-assessment-audit-optimization": {
      ...
      "features": [
        ...
        "Scalability and performance improvement plans",
        "Wireless and mobile network performance testing",
        "Security audits and threat analysis",
        "Detailed reporting and actionable recommendations"
      ],
      "benefits": [
        "Enhanced network performance and reliability",
        "Improved network security and reduced risks",
        "Optimized bandwidth usage and traffic flow",
        "Scalable infrastructure that adapts to future needs",
        "Minimized downtime and network disruptions"
      ]
    }
    ,
    "sustainable-it-infrastructure": {
      ...
      "features": [
        ...
        "Long-term sustainability planning and forecasting",
        "Cost reduction strategies through energy savings",
        "Ongoing monitoring and reporting of energy consumption"
      ],
      "benefits": [
        "Reduced environmental impact and carbon footprint",
        "Lower operational costs through energy efficiency",
        "Increased scalability and future-proof infrastructure",
        "Improved IT performance and reliability",
        "Compliance with sustainability standards and regulations"
      ]
    }
    ,
    "secure-digital-transformation-process-automation": {
      ...
      "features": [
        ...
        "Automation of routine and complex business tasks",
        "Real-time monitoring and reporting of automated processes",
        "Ongoing support and updates for automation systems"
      ],
      "benefits": [
        "Reduced operational costs and human error",
        "Improved efficiency and productivity",
        "Enhanced data security and compliance",
        "Scalable automation solutions for business growth",
        "Faster adaptation to digital transformation initiatives"
      ]
    }
    ,
    "secure-ai-insertion-network-transformation": {
      ...
      "features": [
        ...
        "Automated network traffic management",
        "Integration of AI for predictive analytics and problem prevention",
        "Secure AI deployment with a focus on data protection",
        "Ongoing AI model updates and improvements",
        "Custom AI solutions tailored to your network needs"
      ],
      "benefits": [
        "Improved network performance and efficiency",
        "Enhanced security with real-time threat detection",
        "Optimized resource management and reduced overhead",
        "Scalable and adaptable network architecture",
