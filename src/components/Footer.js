...
const Footer = () => {
    return (
      <footer className="bg-gray-200 pt-16 pb-8 font-nunito">
        <div className="max-w-[1400px] mx-auto px-8 lg:px-16 text-lg">
          {/* Main Footer */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {/* Logo Section */}
            <div>
              <Link href='/' passHref>
                <h2 className="text-4xl font-black text-gray-700 tracking-wider">GET2AI</h2>
                <p className='mb-4 font-extra-light text-gray-700 '>Information Technology</p>
              </Link>
              <p className="text-gray-600 font-light">Bringing Advanced IT Solutions within Your Reach.</p>
            </div>
